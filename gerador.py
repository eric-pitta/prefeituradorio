...
def page_one():
    ...
    st.markdown('''OBS: Antes de continuar não esqueça de verificar se a planilha está sendo compartilhada com o email: 102277867499-compute@developer.gserviceaccount.com
''')
