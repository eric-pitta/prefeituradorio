...
def execute_spreadsheet_operation():
    spreadsheet_id = entry_spreadsheet.get()
...
# Aqui adicionamos um campo de entrada para o ID da planilha.

root = tk.Tk()
root.geometry("300x200")

label_spreadsheet = tk.Label(root, text="Digite o ID da planilha:")
label_spreadsheet.pack(pady=10)

entry_spreadsheet = tk.Entry(root)
entry_spreadsheet.pack(pady=10)
...
button = tk.Button(root, text="Executar script", command=execute_spreadsheet_operation)
button.pack()
